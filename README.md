...
* **Gelişmiş Analiz:**
    * **ROI Hesaplama:** Ekran kartı maliyetinin kaç ayda çıkacağını (Amorti süresi) hesaplar.
    * **Grafiksel Gösterim:** Chart.js ile "Gelir vs Gider" pastası ve "12 Aylık Birikim" projeksiyonu.
* **Akıllı Motor:** Hatalı veri girişlerini tolere eden güvenli backend yapısı.

## Kullanılan Teknolojiler
* **Backend:** Python (Flask)
* **Frontend:** HTML5, Bootstrap 5, Chart.js
* **API:** CoinGecko (Ücretsiz Plan)
